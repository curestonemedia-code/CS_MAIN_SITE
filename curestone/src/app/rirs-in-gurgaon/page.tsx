...
const faqCategory = FAQ_CATEGORIES.find((category) => category.slug === "rirs-gurgaon")!;

const TITLE = "RIRS in Gurgaon: Cure Stone Hospital, Sector 52";
const DESCRIPTION =
  "Considering RIRS in Gurgaon? Meet the surgeon, see Cure Stone Hospital's Sector 52 facility, and how to book — the local decision guide, not the procedure explainer.";
const URL = "https://thecurestone.com/rirs-in-gurgaon";
...
const procedureSchema = {
  ...
  name: "RIRS in Gurgaon at Cure Stone Hospital",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "RIRS Surgery", item: "https://thecurestone.com/rirs" },
    { "@type": "ListItem", position: 3, name: "RIRS in Gurgaon", item: URL },
  ],
};
...
const differentiators = [
  {
    icon: "🔬",
    title: "Fluoroscopy-Free FANS-RIRS",
    desc: "Cure Stone performs RIRS without live X-ray guidance during the procedure — zero radiation exposure for the patient, on a technique not every Gurgaon hospital offers.",
  },
  {
    icon: "🏥",
  ...
  },
  {
    ...
    desc: "Dr. Deepanshu Gupta personally reviews your CT KUB before confirming RIRS is the right fit — not a call-centre triage step.",
  },
];
...
const journey = [
  ...
  { step: "Discharge", desc: "Most patients go home the same day or within 24 hours, straight from the Sector 52 facility." },
  { step: "Local Follow-Up", desc: "Follow-up visits and any stent removal are scheduled back at the same Gurgaon hospital." },
];

export default function RirsInGurgaonPage() {
  return (
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-slate-50 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12 relative z-10 text-center">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 leading-[1.1] mb-6">
            RIRS in Gurgaon: <span className="text-primary italic">Cure Stone Hospital</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-slate-600 font-medium leading-relaxed max-w-2xl mx-auto mb-10">
            Deciding where to have RIRS done in Gurgaon? This is the surgeon, the facility and the booking process — not the procedure explainer.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/rirs" className="px-8 py-4 bg-white border border-slate-200 text-slate-900 font-black rounded-2xl hover:bg-slate-50 transition-all shadow-sm text-center">
              Learn How RIRS Works
            </Link>
          </div>
        </div>
      </section>
      ...
      <main className="flex-grow bg-background">
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-foreground">Why Cure Stone for <span className="text-primary">RIRS in Gurgaon</span></h2>
            </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 mb-8 text-center">Appointment to <span className="text-primary">Recovery at Home</span></h2>
            ...
            <p className="text-center text-sm text-slate-500 font-medium">
              Want the clinical step-by-step of how RIRS itself works?{" "}
              <Link href="/rirs" className="text-primary font-bold underline underline-offset-4">Read the full RIRS guide →</Link>
            </p>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-slate-50">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <p className="text-slate-600 font-medium leading-relaxed mb-4">
              RIRS cost depends on stone size, complexity and length of hospital stay — there is no fixed number until your scan is reviewed. Most patients use cashless health insurance when medically indicated, and Cure Stone&apos;s team handles the documentation and approvals.
            </p>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-3xl mx-auto px-6 lg:px-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-8 text-center">
              RIRS in Gurgaon <span className="text-primary italic">FAQs</span>
            </h2>
        ...
        <section className="py-16 md:py-24 bg-primary">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">Ready to Book RIRS in Gurgaon?</h2>
            ...
            <p className="mt-4">
              <Link href="/rirs" className="text-white/60 text-sm font-bold underline underline-offset-4 hover:text-white">
                ← Back to the RIRS procedure guide
              </Link>
            </p>
          </div>
        </section>
